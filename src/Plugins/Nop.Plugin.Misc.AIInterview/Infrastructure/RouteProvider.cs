...
public class RouteProvider : IRouteProvider
{
    ...
    public void RegisterRoutes(IEndpointRouteBuilder endpointRouteBuilder)
    {
        ...
        endpointRouteBuilder.MapControllerRoute(name: AIInterviewDefaults.AdminFeedbackReportsRouteName,
            pattern: "Admin/AIInterview/FeedbackReports",
            defaults: new { controller = "AIInterviewAdmin", action = "FeedbackReports", area = AreaNames.ADMIN });

        endpointRouteBuilder.MapControllerRoute(name: AIInterviewDefaults.AdminFeedbackReportsListRouteName,
            pattern: "Admin/AIInterview/FeedbackReports/List",
            defaults: new { controller = "AIInterviewAdmin", action = "FeedbackReportsList", area = AreaNames.ADMIN });
        ...
        endpointRouteBuilder.MapControllerRoute(
            name: AIInterviewDefaults.InstituteDashboardRouteName,
            pattern: "institute/dashboard",
            defaults: new { controller = "AIInterview", action = "InstituteDashboard" });

        endpointRouteBuilder.MapControllerRoute(
            name: AIInterviewDefaults.InstituteCandidatesRouteName,
            pattern: "institute/candidates",
            defaults: new { controller = "AIInterview", action = "InstituteCandidates" });

        endpointRouteBuilder.MapControllerRoute(
            name: AIInterviewDefaults.InstituteCreditsRouteName,
            pattern: "institute/credits",
            defaults: new { controller = "AIInterview", action = "InstituteCredits" });

        endpointRouteBuilder.MapControllerRoute(
            name: AIInterviewDefaults.InstituteCandidateInviteRouteName,
            pattern: "institute/candidates/invite",
            defaults: new { controller = "AIInterview", action = "InstituteCandidateInvite" });

        endpointRouteBuilder.MapControllerRoute(
            name: AIInterviewDefaults.InstituteCreditAllotRouteName,
            pattern: "institute/credits/allot",
            defaults: new { controller = "AIInterview", action = "InstituteCreditAllot" });
