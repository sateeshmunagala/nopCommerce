  ...
  <div style=""max-width:640px;margin:0 auto;background:#ffffff;border:1px solid #e5e7eb;border-radius:8px;overflow:hidden;"">
    ...
    protected static Dictionary<string, string> GetAdminLocaleResources()
    {
        return new Dictionary<string, string>
        {
            ...
            ["Plugins.Misc.AIInterview.Admin.MockConfigure.General.Summary"] = "Mock admin experience",
            ...
            ["Plugins.Misc.AIInterview.Admin.MockConfigure.General.Body"] = "This mock page keeps the AIInterview admin entry point polished while previewing the plugin-owned workspace layout.",
            ...
            ["Plugins.Misc.AIInterview.Admin.MockConfigure.CreditPack.Body"] = "No save actions, new workflow, route changes, or additional configuration behavior are introduced on this page.",
            ...
            ["Plugins.Misc.AIInterview.Admin.MockPracticeSessions.Title"] = "Mock Practice Sessions",
            ...
            ["Plugins.Misc.AIInterview.Runtime.Feedback.BackupSpeaker"] = "Turn on backup speaker service",
            ["Plugins.Misc.AIInterview.Runtime.Feedback.BackupSpeakerNote"] = "this backup services only works for chrome browser.",
    ...
    public override async Task InstallAsync()
    {
        ...
        await _localizationService.AddOrUpdateLocaleResourceAsync(new Dictionary<string, string>
        {
            ...
            [$"{AIInterviewDefaults.LocalizationPrefix}.Runtime.Feedback.BackupSpeaker"] = "Turn on backup speaker service",
            [$"{AIInterviewDefaults.LocalizationPrefix}.Runtime.Feedback.BackupSpeakerNote"] = "this backup services only works for chrome browser.",
