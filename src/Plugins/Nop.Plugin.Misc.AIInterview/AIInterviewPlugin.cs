...
public class AIInterviewPlugin : BasePlugin, IMiscPlugin, IWidgetPlugin
{
    ...
    protected static Dictionary<string, string> GetAdminLocaleResources()
    {
        return new Dictionary<string, string>
        {
            ...
            ["Plugins.Misc.AIInterview.Admin.Credits.Activity.SearchCustomerId"] = "Customer ID",
            ["Plugins.Misc.AIInterview.Admin.Credits.Activity.SearchKeyword"] = "Customer name or email",
            ["Plugins.Misc.AIInterview.Admin.Credits.Activity.SearchHasPositiveBalanceOnly"] = "Positive balance only",
            ["Plugins.Misc.AIInterview.Admin.Credits.Activity.SearchActivityDateFromUtc"] = "Activity date from (UTC)",
            ["Plugins.Misc.AIInterview.Admin.Credits.Activity.SearchActivityDateToUtc"] = "Activity date to (UTC)",
