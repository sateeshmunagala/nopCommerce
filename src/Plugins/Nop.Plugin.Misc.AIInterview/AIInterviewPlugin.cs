...
<p><a href=""%AIInterview.CandidateDetailsUrl%"">Open Candidate Details</a></p>",
    ...
    protected static Dictionary<string, string> GetUpgradeLocaleResources()
    {
        return new Dictionary<string, string>
        {
            ...
            [$"{AIInterviewDefaults.LocalizationPrefix}.History.Delete"] = "Delete interview",
            [$"{AIInterviewDefaults.LocalizationPrefix}.History.DeleteConfirm"] = "Are you sure you want to remove this completed interview from your account?",
            [$"{AIInterviewDefaults.LocalizationPrefix}.History.Deleted"] = "The interview was removed from your account.",
            [$"{AIInterviewDefaults.LocalizationPrefix}.History.DeleteNotAllowed"] = "The completed interview could not be removed.",
            ...
            ["Plugins.Misc.AIInterview.Admin.AiService.RecordingUploadTimeoutMs.Hint"] = "Allowed range: 5000 to 120000 milliseconds.",
            ...
            [$"{AIInterviewDefaults.LocalizationPrefix}.Employer.Applications.ReusedInterview"] = "Reused interview",
            ...
            [$"{AIInterviewDefaults.LocalizationPrefix}.Interview.StartCreditNotice"] = "Note: You can review guidelines and instructions on the next page. Your credits will be debited on the next page when starting the session.",
            [$"{AIInterviewDefaults.LocalizationPrefix}.Login.CompanySponsoredNotice"] = "You need to login first to take this company sponsored interview.",
            ...
            [$"{AIInterviewDefaults.LocalizationPrefix}.JobDetails.NumberOfPositions"] = "Number of Positions",
            ...
            [$"{AIInterviewDefaults.LocalizationPrefix}.Employer.Jobs.Link"] = "Link",
            [$"{AIInterviewDefaults.LocalizationPrefix}.Employer.Jobs.CopyLink"] = "Copy job link",
            ...
            [$"{AIInterviewDefaults.LocalizationPrefix}.VendorJobCreation.AiDescription.GenerateButton"] = "Generate with AI",
            [$"{AIInterviewDefaults.LocalizationPrefix}.VendorJobCreation.AiDescription.ModalTitle"] = "Generate job description",
            [$"{AIInterviewDefaults.LocalizationPrefix}.VendorJobCreation.AiDescription.Keywords"] = "Keywords",
            [$"{AIInterviewDefaults.LocalizationPrefix}.VendorJobCreation.AiDescription.Tone"] = "Tone of voice",
            [$"{AIInterviewDefaults.LocalizationPrefix}.VendorJobCreation.AiDescription.Tone.Expert"] = "Expert",
            [$"{AIInterviewDefaults.LocalizationPrefix}.VendorJobCreation.AiDescription.Tone.Supportive"] = "Supportive",
            [$"{AIInterviewDefaults.LocalizationPrefix}.VendorJobCreation.AiDescription.Tone.Custom"] = "Custom",
            [$"{AIInterviewDefaults.LocalizationPrefix}.VendorJobCreation.AiDescription.CustomTone"] = "Custom tone description",
            [$"{AIInterviewDefaults.LocalizationPrefix}.VendorJobCreation.AiDescription.Instructions"] = "Special instructions",
            [$"{AIInterviewDefaults.LocalizationPrefix}.VendorJobCreation.AiDescription.Generate"] = "Generate",
            [$"{AIInterviewDefaults.LocalizationPrefix}.VendorJobCreation.AiDescription.Preview"] = "Generated description",
            [$"{AIInterviewDefaults.LocalizationPrefix}.VendorJobCreation.AiDescription.Cancel"] = "Cancel",
            [$"{AIInterviewDefaults.LocalizationPrefix}.VendorJobCreation.AiDescription.Use"] = "Use this description",
            [$"{AIInterviewDefaults.LocalizationPrefix}.VendorJobCreation.AiDescription.Unauthorized"] = "You are not authorized to use this feature.",
            [$"{AIInterviewDefaults.LocalizationPrefix}.VendorJobCreation.AiDescription.NotConfigured"] = "AI description generation is not available right now.",
            [$"{AIInterviewDefaults.LocalizationPrefix}.VendorJobCreation.AiDescription.MissingFields"] = "Please provide a job title and some keywords first.",
            [$"{AIInterviewDefaults.LocalizationPrefix}.VendorJobCreation.Sku"] = "Reference code",
            [$"{AIInterviewDefaults.LocalizationPrefix}.VendorJobCreation.NumberOfPositions"] = "Number of positions",
            [$"{AIInterviewDefaults.LocalizationPrefix}.VendorJobCreation.NumberOfPositions.Invalid"] = "Number of positions must be at least 1.",
    ...
    protected static Dictionary<string, string> GetAdminLocaleResources()
    {
        return new Dictionary<string, string>
        {
            ...
            ["Plugins.Misc.AIInterview.Admin.Credits.Deduction.Remarks"] = "Admin deduction",
            ["Plugins.Misc.AIInterview.Admin.Credits.Deduction.Success"] = "Credits deducted successfully.",
            ["Plugins.Misc.AIInterview.Admin.Credits.Deduction.InsufficientBalance"] = "The deduction exceeds the applicant's current wallet balance.",
    ...
    protected static Dictionary<string, string> GetEmployerApplicationsLocaleResources()
    {
        return new Dictionary<string, string>
        {
            ...
            [$"{AIInterviewDefaults.LocalizationPrefix}.Employer.Invite.Expiry"] = "Expires",
    ...
    public override async Task InstallAsync()
    {
        ...
        await _localizationService.AddOrUpdateLocaleResourceAsync(new Dictionary<string, string>
        {
            ...
            [$"{AIInterviewDefaults.LocalizationPrefix}.Apply.InterviewRecord"] = "Select a completed interview",
            [$"{AIInterviewDefaults.LocalizationPrefix}.Apply.InterviewRecord.Placeholder"] = "Choose an interview record",
            [$"{AIInterviewDefaults.LocalizationPrefix}.Apply.InterviewRecord.Required"] = "Please select a completed interview record.",
            [$"{AIInterviewDefaults.LocalizationPrefix}.Apply.InterviewRecord.None"] = "You must take an AI interview within the last 180 days before applying.",
            [$"{AIInterviewDefaults.LocalizationPrefix}.Apply.InterviewRecord.Help"] = "Choose any completed interview from the last 180 days, from this job or another job or mock practice.",
            ...
            [$"{AIInterviewDefaults.LocalizationPrefix}.Admin.Credits.Deduction.Remarks"] = "Admin deduction",
            [$"{AIInterviewDefaults.LocalizationPrefix}.Admin.Credits.Deduction.Success"] = "Credits deducted successfully.",
            [$"{AIInterviewDefaults.LocalizationPrefix}.Admin.Credits.Deduction.InsufficientBalance"] = "The deduction exceeds the applicant's current wallet balance.",
            ...
            [$"{AIInterviewDefaults.LocalizationPrefix}.Employer.Credits.Available"] = "Available",
            [$"{AIInterviewDefaults.LocalizationPrefix}.Employer.Credits.InvitesSent"] = "Invites Sent",
            [$"{AIInterviewDefaults.LocalizationPrefix}.Employer.Credits.Used"] = "Used",
            [$"{AIInterviewDefaults.LocalizationPrefix}.Employer.Invite.EmailPlaceholder"] = "Enter candidate emails separated by commas, semicolons, or new lines",
            [$"{AIInterviewDefaults.LocalizationPrefix}.Employer.Invite.EmailHelpText"] = "Separate multiple candidate email addresses with commas, semicolons, or new lines.",
