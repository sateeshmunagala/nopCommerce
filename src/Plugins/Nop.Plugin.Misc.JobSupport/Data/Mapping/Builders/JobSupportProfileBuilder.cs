...
public class JobSupportProfileBuilder : NopEntityBuilder<JobSupportProfile>
{
    public override void MapEntity(CreateTableExpressionBuilder table)
    {
        table
            ...
            .WithColumn(nameof(JobSupportProfile.Slug)).AsString(int.MaxValue).Nullable()
            .WithColumn(nameof(JobSupportProfile.AvailabilityDays)).AsString(int.MaxValue).Nullable()
            .WithColumn(nameof(JobSupportProfile.AvailabilityTimings)).AsString(int.MaxValue).Nullable()
            .WithColumn(nameof(JobSupportProfile.HoursPerWeek)).AsString(int.MaxValue).Nullable()
